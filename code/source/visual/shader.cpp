...
void Shader::setUniform(const char* name, const util::Mat44f& value, int32 count)
{
	glUniformMatrix4fv(uniformLoc(name), count, GL_FALSE, value.data());
}
