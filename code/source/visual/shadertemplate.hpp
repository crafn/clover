...
public:
	...
	const util::DynArray<util::Str8>& getOptions() const { return options.get(); }

	const util::Str8& getVertCode() const { return vertCode; }
	const util::Str8& getFragCode() const { return fragCode; }
	const util::Str8& getGeomCode() const { return geomCode; }
...
private:
	...
	RESOURCE_ATTRIBUTE(StringArray, options)
